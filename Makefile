...
all:
	...
	g++ $(FLAGS) src/Planilla2.cpp -o bin/Planilla2.o
	g++ $(FLAGS) src/main.cpp -o bin/main.o
	g++ -g -o bin/planilla bin/TipoEmpleado.o bin/ProfesionalHoras.o bin/EmpleadoNomina.o bin/Planilla2.o bin/main.o
test:
	mkdir -p bin
